    ...
    return (
        <Stack direction="column">
            ...
            >
                ...
                <Stack direction="column" spacing={2} alignItems="center" width="500px" sx={{
                    padding: "70px 50px",
                    ...
                    <Typography
                        ...
                        textAlign="center"
                        paddingY={4}
                        sx={{ borderTop: `1px solid ${Colors.BLACK}`, borderBottom: `1px solid ${Colors.BLACK}` }}
                    >
                        {" "}
            ...
            <Link to={routes.FIXME} style={{ marginLeft: "auto", marginRight: "auto" }}>
