...
export default function ShipInDetailsPage() {
    ...
    const selectOption = (option: string) => {
        ...
        if (option === "ship-in" || option === "door-to-door") {
            // If a link is clicked, log the value of the "ask" state
            setAsk(true);
            // console.log("ask state when link is clicked:", ask);
            ...
            if (e !== "/schedule-repair") {
                ...
                if (ask === true) {
                    const userConfirmed = window.confirm(
                        `Are you sure you want to leave this page? ${router}`
                    );

                    console.log("6r65e43543", ask, e);
                    // alert("nooooooo");
                    if (userConfirmed) {
                        navigate(e);
                    }
                } else {
                    // No need for a confirmation when "ask" is not true
                    navigate(e);
                }
            }
            console.log(e);
