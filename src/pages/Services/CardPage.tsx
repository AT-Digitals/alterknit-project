        ...
        <>
                ...
                <Card style={{
                    ...
                    <CardContent>
                        <Box display={"flex"} alignItems={"center"} justifyContent={"space-around"}>
                            <Typography marginTop={"45px"} lineHeight={"1"} color={"black"} fontWeight={"bold"} fontSize={"30px"}>CAN I GET A <Typography color={"black"} fontWeight={"bold"} fontSize={"30px"}>BALLPARK?</Typography> <Typography fontStyle={"italic"} color={"#575656"} fontWeight={"500"} marginTop={"7px"} fontSize={"20px"}>It's just one hole!</Typography></Typography>
                            <Typography lineHeight={"1.3"} maxWidth={"676px"} marginTop={"30px"} color={"black"} fontWeight={"500"} fontSize={"20px"}>We need to examine your entire item in our work studio because we have been doing this for a very long time and what might appear to you as a small hole could in reality be 17 small holes! So please let us do our job. Your garments' examination is complimentary.</Typography>
                        </Box>
            ...
            <Box display={"flex"} justifyContent={"center"} sx={{
                ...
                <Card style={{
                    ...
                    <CardContent>
                        <Box marginTop={"12px"} display={"flex"} alignItems={"center"} justifyContent={"space-around"}>
                            <Typography lineHeight={"1"} color={"black"} fontWeight={"bold"} fontSize={"30px"}>WHERE ARE YOU<Typography color={"black"} fontWeight={"bold"} fontSize={"30px"}>LOCATED?</Typography> <Typography fontStyle={"italic"} color={"#575656"} fontWeight={"500"} marginTop={"7px"} fontSize={"20px"}>Queens, New York</Typography></Typography>
                            <Typography marginBottom={"20px"} lineHeight={"1.3"} maxWidth={"676px"} marginTop={"30px"} color={"black"} fontWeight={"500"} fontSize={"20px"}>Can I drop by? Our work studio is located in Astoria, Queens, New York. We know you would like to visit but due to the high intensity nature of the service we provide we do not accept walk-ins. All shipped in orders go to a secure package facility to ensure the safety of your items so you can feel confident that your order has been received.</Typography>
                        </Box>
                    </CardContent>
                </Card>
            </Box>
            <Box display={"flex"} justifyContent={"center"} sx={{
                ...
                <Card style={{
                    ...
                    <CardContent>
                        <Box marginTop={"12px"} display={"flex"} alignItems={"center"} justifyContent={"space-around"}>
                            <Typography marginTop={"20px"} lineHeight={"1"} color={"black"} fontWeight={"bold"} fontSize={"30px"}>HOW LONG WILL<Typography color={"black"} fontWeight={"bold"} fontSize={"30px"}>IT TAKE?</Typography> <Typography fontStyle={"italic"} color={"#575656"} fontWeight={"500"} marginTop={"7px"} fontSize={"20px"}>Typically 4-6 Weeks</Typography></Typography>
                            <Typography marginBottom={"20px"} lineHeight={"1.3"} maxWidth={"676px"} marginTop={"25px"} color={"black"} fontWeight={"500"} fontSize={"20px"}>We are working on a 4-6 week turnaround time. However, if you have an upcoming event, vacation, or you can't live without it, please let a team member know when they call you to go over your order. We offer a rush service for an additional fee.</Typography>
                        </Box>
                    </CardContent>
                </Card>
            </Box>
