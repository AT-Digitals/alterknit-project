...
import image1 from "../../assets/1679605963784_Line of Trade.png"
import { Stack, Typography, useMediaQuery } from '@mui/material';
import CloseIcon from '@mui/icons-material/Close';
import image2 from "../../assets/1679605963784_Line of Trade (1).png";

export default function Cloth16Modal() {
      ...
      >
       <Stack direction= 'row' sx={{
         ...
         <Box width={{xs: "290px", sm: "480px", md: "480px", lg: "480px"}} height={{xs: "390px", sm: "550px", md: "550px", lg: "550px"}} style={{
                ...
                <Typography fontFamily={`"ProximaNovaMedium", sans-serif`}  color={"black"} fontSize={"22px"} fontWeight={"600"}>LINE OF TRADE</Typography>
                </Box>
                </Box>
