...
import image1 from "../../assets/1679605990858_Marimekko.jpg"
import { Stack, Typography } from '@mui/material';
import CloseIcon from '@mui/icons-material/Close';
import image2 from "../../assets/1679605990858_Marimekko (1).jpg";

export default function Cloth15Modal() {
      ...
      >
        <Stack sx={{
         ...
         <Box style={{
                ...
                <Typography fontFamily={`"ProximaNovaMedium", sans-serif`}  color={"black"} fontSize={"22px"} fontWeight={"600"}>MARIMEKKO</Typography>
                </Box>
                </Box>
                <Box style={{
                    width: "480px",
