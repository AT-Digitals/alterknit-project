...
import image1 from "../../assets/1679605771784_Dries Van Noten.jpeg"
import { Stack, Typography, useMediaQuery } from '@mui/material';
import CloseIcon from '@mui/icons-material/Close';
import image2 from "../../assets/1679605771784_Dries Van Noten (1).jpeg";

export default function Cloth9Modal() {
  ...
  return (
    <>
    <Box marginTop={{xs: "-30px", sm: "-59px", md: "-62px", lg:" 0px"}} marginBottom={{xs: "-15px", sm: "-39px", md: "-45px", lg:" 0px"}}>
      <img style={{
                    width: "100%",
                    height: "100%",
                    objectFit: "cover"
      ...
      >
        <Stack direction= 'row' sx={{
         ...
         <Box padding={{xs: '5px', sm: "6px", md: "6px", lg: "7px"}} width={{xs: "290px", sm: "480px", md: "480px", lg: "480px"}} height={{xs: "390px", sm: "550px", md: "550px", lg: "550px"}} style={{
                ...
                <Typography fontFamily={`"ProximaNovaMedium", sans-serif`}  color={"black"} fontSize={"22px"} fontWeight={"600"}>DRIES VAN NOTEN</Typography>
                </Box>
                </Box>
