...
import image1 from "../../assets/1679605690207_Britches.jpg"
import { Stack, Typography, useMediaQuery } from '@mui/material';
import CloseIcon from '@mui/icons-material/Close';
import image2 from "../../assets/1679605690207_Britches (1).jpg"
    ...
    <>
      ...
      >
         ...
         <Box padding={{xs: '5px', sm: "6px", md: "6px", lg: "7px"}} width={{xs: "290px", sm: "480px", md: "480px", lg: "480px"}} height={{xs: "390px", sm: "550px", md: "550px", lg: "550px"}} style={{
                ...
                <Typography fontFamily={`"ProximaNovaMedium", sans-serif`}  color={"black"} fontSize={"22px"} fontWeight={"600"}>BRITCHES</Typography>
                </Box>
                </Box>
