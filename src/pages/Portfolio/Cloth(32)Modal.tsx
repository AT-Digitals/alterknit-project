...
import image1 from "../../assets/1679606149531_Taylor Stitch.jpg"
import { Stack, Typography } from '@mui/material';
import CloseIcon from '@mui/icons-material/Close';
import image2 from "../../assets/1679606149531_Taylor Stitch (1).jpg";

export default function Cloth28Modal() {
      ...
      >
        <Stack sx={{
         ...
         <Box style={{
                ...
                <Typography   color={"black"} fontSize={"1.3rem"}>TAYLOR STITCH</Typography>
                </Box>
                </Box>
                <Box style={{
                   width: "480px",
